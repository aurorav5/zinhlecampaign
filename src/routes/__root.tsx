...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "The scars are still part of the story. They just aren't writing it anymore. The most beautiful \"FU\" is not anger but becoming everything you never dreamed." },
      { name: "twitter:description", content: "The scars are still part of the story. They just aren't writing it anymore. The most beautiful \"FU\" is not anger but becoming everything you never dreamed." },
      ...
      { name: "description", content: "The scars are still part of the story. They just aren't writing it anymore. The most beautiful \"FU\" is not anger but becoming everything you never dreamed." },
    ],
    links: [
